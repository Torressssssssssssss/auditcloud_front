  ...
  template: `
    <svg 
      ...
      @switch (name) {
        ...
        @case ('timeline') {
          <path d="M11 3h2v18h-2V3zm-6 2c-1.66 0-3 1.34-3 3s1.34 3 3 3c1.3 0 2.4-.84 2.82-2H10V7H7.82C7.4 5.84 6.3 5 5 5zm0 4c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm14 4c-1.3 0-2.4.84-2.82 2H14v2h2.18c.42 1.16 1.52 2 2.82 2 1.66 0 3-1.34 3-3s-1.34-3-3-3zm0 4c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1z"/>
        }
        @case ('folder') {
